...
function preload() {
    queue.loadFile({
        id: "sceneryOutside",
        src: sceneryOutsideSrc
    }), queue.loadFile({
        id: "sceneryInside",
        src: sceneryInsideSrc
    }), Modernizr.touch && queue.loadFile({
        id: "gifanimation",
        src: src + "/animation/animation.gif"
    }), queue.loadFile({
        id: "animation",
        src: animationSrc
    }), queue.loadFile({
        id: "slothAnimation",
        src: slothAnimationSrc
    }), queue.loadFile({
        id: "underwaterAnimation",
        src: underwaterAniSrc
    }), queue.loadFile("javascripts/waapisim.js"), queue.loadFile("javascripts/flashcanvas.js"), queue.loadFile("javascripts/throttle.min.js"), queue.loadFile("javascripts/script.js");
    for (var e in audioFilenames) queue.loadFile({
        id: audioFilenames[e].name,
        src: audioSrc + audioFilenames[e].name,
...
function handleFileLoad(e) {
    if (e.item.audio === !0) {
        var t = audioFilenames[e.item.number];
        t.result = queue.getResult(t.name), decodeSound(t)
    }
}

function handleProgress(e) {
    var t = 100 * e.loaded.toFixed(2);
    document.getElementById("loadingbar").style.width = t + "%"
}

function handleComplete() {
    var e = document.getElementById("animationwrapper"),
        t = queue.getResult("sceneryInside");
    document.getElementById("inside").appendChild(t);
    var n = queue.getResult("sceneryOutside");
    document.getElementById("outside").appendChild(n).setAttribute("id", "outsideImg"), document.getElementById("outsideImg").style.visibility = "hidden";
    var r = queue.getResult("slothAnimation");
    e.appendChild(r).setAttribute("id", "slothimg");
    var i = $("#slothimg");
    i.css("left", window.innerWidth / 2 - i.width() / 2);
    var o = queue.getResult("underwaterAnimation");
    e.appendChild(o).setAttribute("id", "underwaterimg");
    var a = $("#underwaterimg"),
        s = document.getElementById("underwater").getBoundingClientRect();
    a.css("left", s.left + "px").css("top", s.top - $("#animationwrapper").offset().top + "px").css("width", s.width);
    var u = document.getElementById("successwrapper"),
        c = queue.getResult("successSentence");
    u.insertBefore(c, u.firstChild).setAttribute("id", "successSentence");
    var l = queue.getResult("successSloth");
    if (u.insertBefore(l, u.firstChild).setAttribute("id", "successSloth"), Modernizr.touch) {
        var f = queue.getResult("gifanimation");
        e.appendChild(f).setAttribute("id", "animationgif");
        var d = $("#animationgif");
        d.css("left", window.innerWidth / 2 - d.width() / 2)
    }
    complete = !0, playClicked && audioDecoded && setTimeout(function() {
        initGame()
    }, 500)
}

function playButtonClick() {
    playClicked = !0, _gaq.push(["_trackEvent", "game", "click", "play"]), complete && audioDecoded ? initGame() : showLoadingBar()
}
...
function initGame() {
    ...
    e.css("opacity", "0"), setTimeout(function() {
        e.css("display", "none")
    }, 250), title = !1, init(), _gaq.push(["_trackPageview"]), _gaq.push(["_trackEvent", "game", "start"])
}

function decodeSound(e) {
    audioContext.decodeAudioData(e.result, function(t) {
        e.buffer = t, e.loaded = !0, counter++, counter === audioFilenames.length && (audioDecoded = !0, complete && playClicked && initGame())
    })
}

function showLoadingBar() {
    var e = document.getElementById("loadingbar");
    e.style.visibility = "visible", e.style.opacity = "1";
    var t = document.getElementById("loadingindicator");
    t.style.visibility = "visible", t.style.opacity = "1"
}

function centerLoadingwrapper() {
    loadingwrapper.css("opacity", 1), loadingwrapper.css("margin-top", loadingwrapper.height() / 2 * -1), loadingwrapper.css("margin-left", loadingwrapper.width() / 2 * -1)
}

function playMobile() {
    preload(), showLoadingBar(), _gaq.push(["_trackEvent", "mobile", "click", "playAnyway"]), $("#warning").css("width", "0").css("height", "0").css("opacity", "0")
}
window.Modernizr = function(e, t, n) {
    ...
    function c(e, t, n) {
        ...
        return o(t, "string") || o(t, "undefined") ? s(i, t) : (i = (e + " " + S.join(r + " ") + r).split(" "), u(i, t, n))
    }

    function l() {
        h.input = function(n) {
            for (var r = 0, i = n.length; i > r; r++) A[n[r]] = !! (n[r] in b);
            ...
            for (var r, i, o, a = 0, s = e.length; s > a; a++) b.setAttribute("type", i = e[a]), r = "text" !== b.type, r && (b.value = w, b.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(i) && b.style.WebkitAppearance !== n ? (m.appendChild(b), o = t.defaultView, r = o.getComputedStyle && "textfield" !== o.getComputedStyle(b, null).WebkitAppearance && 0 !== b.offsetHeight, m.removeChild(b)) : /^(search|tel)$/.test(i) || (r = /^(url|email)$/.test(i) ? b.checkValidity && b.checkValidity() === !1 : b.value != w)), D[e[a]] = !! r;
            return D
    ...
    var f, d, p = "2.8.3",
        ...
        F = function(e, n, r, i) {
            ...
            return o = ["&#173;", '<style id="s', v, '">', e, "</style>"].join(""), c.id = v, (l ? c : f).innerHTML += o, f.appendChild(c), l || (f.style.background = "", f.style.overflow = "hidden", u = m.style.overflow, m.style.overflow = "hidden", m.appendChild(f)), a = n(c, e), l ? c.parentNode.removeChild(c) : (f.parentNode.removeChild(f), m.style.overflow = u), !! a
        }, H = function(t) {
        ...
        M = {}.hasOwnProperty;
    d = o(M, "undefined") || o(M.call, "undefined") ? function(e, t) {
        ...
        var n = L.call(arguments, 1),
            r = function() {
                if (this instanceof r) {
                    ...
                    var o = new i,
                        a = t.apply(o, n.concat(L.call(arguments)));
        ...
        var n;
        return "ontouchstart" in e || e.DocumentTouch && t instanceof DocumentTouch ? n = !0 : F(["@media (", T.join("touch-enabled),("), v, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function(e) {
            n = 9 === e.offsetTop
        }), n
        ...
        return r((e + "-webkit- ".split(" ").join(t + e) + T.join(n + e)).slice(0, -e.length)), a(x.backgroundImage, "gradient")
        ...
        var e = !! c("perspective");
        return e && "webkitPerspective" in m.style && F("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}", function(t) {
        ...
        var e;
        return F(["#", v, "{font:0/0 a}#", v, ':after{content:"', w, '";visibility:hidden;font:3px/1 a}'].join(""), function(t) {
            e = t.offsetHeight >= 3
        }), e
    }, j.video = function() {
    ...
    for (var O in j) d(j, O) && (f = O.toLowerCase(), h[f] = j[O](), q.push((h[f] ? "" : "no-") + f));
    ...
    function(e, t) {
        ...
        e.html5 = y, u(t)
    }(this, t), h._version = p, h._prefixes = T, h._domPrefixes = S, h._cssomPrefixes = k, h.mq = H, h.hasEvent = P, h.testProp = function(e) {
        return s([e])
    }, h.testAllProps = c, h.testStyles = F, h.prefixed = function(e, t, n) {
        return t ? c(e, t, n) : c(e, "pfx")
    }, m.className = m.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (g ? " js " + q.join(" ") : ""), h
}(this, this.document),
/*!
...
function(e, t) {
    ...
    function b(e) {
        var t = J,
            n = It[e];
        return n || (n = x(e, t), "none" !== n && n || ($t = ($t || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = $t[0].contentDocument, t.write(), t.close(), n = x(e, t), $t.detach()), It[e] = n), n
    }

    function w(e, t, n) {
        var r, i, o, a, s = e.style;
        return n = n || _t(e), n && (a = n.getPropertyValue(t) || n[t]), n && ("" !== a || Z.contains(e.ownerDocument, e) || (a = Z.style(e, t)), Wt.test(a) && Bt.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 !== a ? a + "" : a
    }
    ...
    function k(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 > o; o += 2) "margin" === n && (a += Z.css(e, n + Ct[o], !0, i)), r ? ("content" === n && (a -= Z.css(e, "padding" + Ct[o], !0, i)), "margin" !== n && (a -= Z.css(e, "border" + Ct[o] + "Width", !0, i))) : (a += Z.css(e, "padding" + Ct[o], !0, i), "padding" !== n && (a += Z.css(e, "border" + Ct[o] + "Width", !0, i)));
        return a
    }
    ...
    function N(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++) r = e[a], r.style && (o[a] = vt.get(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && Tt(r) && (o[a] = vt.access(r, "olddisplay", b(r.nodeName)))) : (i = Tt(r), "none" === n && i || vt.set(r, "olddisplay", i ? n : Z.css(r, "display"))));
    ...
    function L(e, t, n) {
        ...
        })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], c = Z.css(e, "display"), l = "none" === c ? vt.get(e, "olddisplay") || b(e.nodeName) : c, "inline" === l && "none" === Z.css(e, "float") && (p.display = "inline-block")), n.overflow && (p.overflow = "hidden", f.always(function() {
        ...
        if (Z.isEmptyObject(d)) "inline" === ("none" === c ? b(e.nodeName) : c) && (p.display = c);
        else {
            ...
            for (r in d) a = q(h ? g[r] : 0, r, f), r in g || (g[r] = a.start, h && (a.end = a.start, a.start = "width" === r || "height" === r ? 1 : 0))
        }
    }
    ...
    function H(e, t, n) {
        ...
        for (F(l, c.opts.specialEasing); a > o; o++)
            if (r = tn[o].call(c, e, l, c.opts)) return r;
    ...
    function I(e, t, n, r) {
        ...
        if (Z.isArray(t)) Z.each(t, function(t, i) {
            n || kn.test(e) ? r(e, i) : I(e + "[" + ("object" == typeof i ? t : "") + "]", i, n, r)
        });
    ...
    function(e) {
        function t(e, t, n, r) {
            ...
            if ((t ? t.ownerDocument || t : I) !== L && q(t), t = t || L, n = n || [], s = t.nodeType, "string" != typeof e || !e || 1 !== s && 9 !== s && 11 !== s) return n;
            if (!r && H) {
                if (11 !== s && (i = yt.exec(e)))
                    if (a = i[1]) {
                        if (9 === s) {
                ...
                if (w.qsa && (!P || !P.test(e))) {
                    if (p = f = $, h = t, g = 1 !== s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
                        for (c = k(e), (f = t.getAttribute("id")) ? p = f.replace(bt, "\\$&") : t.setAttribute("id", p), p = "[id='" + p + "'] ", u = c.length; u--;) c[u] = p + d(c[u]);
        ...
        function p(e, t, n) {
            ...
            return t.first ? function(t, n, o) {
                ...
                if (a) {
                    ...
                    for (; t = t[r];)
                        if (1 === t.nodeType || i) {
                            if (u = t[$] || (t[$] = {}), (s = u[r]) && s[0] === B && s[1] === o) return c[2] = s[2];
        ...
        function v(e, t, n, i, o, a) {
            return i && !i[$] && (i = v(i)), o && !o[$] && (o = v(o, a)), r(function(r, a, s, u) {
                var c, l, f, d = [],
                    ...
                    x = n ? o || (r ? e : h || i) ? [] : a : y;
                if (n && n(y, x, s, u), i)
                    for (c = m(x, p), i(c, [], s, u), l = c.length; l--;)(f = c[l]) && (x[p[l]] = !(y[p[l]] = f));
                if (r) {
                    if (o || e) {
                        if (o) {
                        ...
                        for (l = x.length; l--;)(f = x[l]) && (c = o ? et(r, f) : d[l]) > -1 && (r[c] = !(a[c] = f))
                    }
            ...
            var i = n.length > 0,
                ...
                a = function(r, a, s, u, c) {
                    var l, f, d, p = 0,
                        ...
                        w = x.length;
                    for (c && (j = a !== L && a); h !== w && null != (l = x[h]); h++) {
                        if (o && l) {
                            for (f = 0; d = e[f++];)
                                if (d(l, a, s)) {
                                    u.push(l);
        ...
        var b, w, C, T, E, k, S, N, j, D, A, q, L, F, H, P, M, O, R, $ = "sizzle" + 1 * new Date,
            I = e.document,
            B = 0,
            W = 0,
            _ = n(),
        ...
        w = t.support = {}, E = t.isXML = function(e) {
            ...
            return r !== L && 9 === r.nodeType && r.documentElement ? (L = r, F = r.documentElement, n = r.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Tt, !1) : n.attachEvent && n.attachEvent("onunload", Tt)), H = !E(r), w.attributes = i(function(e) {
                return e.className = "i", !e.getAttribute("className")
            }), w.getElementsByTagName = i(function(e) {
                return e.appendChild(r.createComment("")), !e.getElementsByTagName("*").length
            }), w.getElementsByClassName = vt.test(r.getElementsByClassName), w.getById = i(function(e) {
                return F.appendChild(e).id = $, !r.getElementsByName || !r.getElementsByName($).length
                ...
                w.disconnectedMatch = O.call(e, "div"), O.call(e, "[s!='']:x"), M.push("!=", at)
            }), P = P.length && new RegExp(P.join("|")), M = M.length && new RegExp(M.join("|")), t = vt.test(F.compareDocumentPosition), R = t || vt.test(F.contains) ? function(e, t) {
                ...
                return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === r || e.ownerDocument === I && R(I, e) ? -1 : t === r || t.ownerDocument === I && R(I, t) ? 1 : D ? et(D, e) - et(D, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t) return A = !0, 0;
                var n, i = 0,
                    o = e.parentNode,
            ...
            if ((e.ownerDocument || e) !== L && q(e), n = n.replace(ft, "='$1']"), !(!w.matchesSelector || !H || M && M.test(n) || P && P.test(n))) try {
                var r = O.call(e, n);
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (m) {
                            ...
                            if (h = [a ? m.firstChild : m.lastChild], a && y) {
                                for (l = m[$] || (m[$] = {}), c = l[e] || [], p = c[0] === B && c[1], d = c[0] === B && c[2], f = p && m.childNodes[p]; f = ++p && f && f[g] || (d = p = 0) || h.pop();)
                                    if (1 === f.nodeType && ++d && f === t) {
                                        l[e] = [B, p, d];
                                        break
                                    }
                            } else if (y && (c = (t[$] || (t[$] = {}))[e]) && c[0] === B) d = c[1];
                            else
                                for (;
                                    (f = ++p && f && f[g] || (d = p = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++d || (y && ((f[$] || (f[$] = {}))[e] = [B, d]), f !== t)););
        ...
        return f.prototype = C.filters = C.pseudos, C.setFilters = new f, k = t.tokenize = function(e, n) {
            ...
            if (n = n || [], 1 === f.length) {
                if (o = f[0] = f[0].slice(0), o.length > 2 && "ID" === (a = o[0]).type && w.getById && 9 === t.nodeType && H && C.relative[o[1].type]) {
                ...
                for (i = ht.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !C.relative[s = a.type]);)
                    if ((u = C.find[s]) && (r = u(a.matches[0].replace(wt, Ct), xt.test(o[0].type) && l(t.parentNode) || t))) {
                        if (o.splice(i, 1), e = r.length && d(o), !e) return K.apply(n, r), n;
                        break
                    }
            }
            return (c || S(e, f))(r, t, !H, n, xt.test(e) && l(t.parentNode) || t), n
        }, w.sortStable = $.split("").sort(U).join("") === $, w.detectDuplicates = !! A, q(), w.sortDetached = i(function(e) {
    ...
    Z.event = {
        ...
        add: function(e, t, n, r, i) {
            var o, a, s, u, c, l, f, d, p, h, g, m = vt.get(e);
            if (m)
                for (n.handler && (o = n, n = o.handler, i = o.selector), n.guid || (n.guid = Z.guid++), (u = m.events) || (u = m.events = {}), (a = m.handle) || (a = m.handle = function(t) {
                ...
                }), t = (t || "").match(pt) || [""], c = t.length; c--;) s = Dt.exec(t[c]) || [], p = g = s[1], h = (s[2] || "").split(".").sort(), p && (f = Z.event.special[p] || {}, p = (i ? f.delegateType : f.bindType) || p, f = Z.event.special[p] || {}, l = Z.extend({
                    type: p,
                    origType: g,
                    data: r,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, o), (d = u[p]) || (d = u[p] = [], d.delegateCount = 0, f.setup && f.setup.call(e, r, h, a) !== !1 || e.addEventListener && e.addEventListener(p, a, !1)), f.add && (f.add.call(e, l), l.handler.guid || (l.handler.guid = n.guid)), i ? d.splice(d.delegateCount++, 0, l) : d.push(l), Z.event.global[p] = !0)
        },
        remove: function(e, t, n, r, i) {
            var o, a, s, u, c, l, f, d, p, h, g, m = vt.hasData(e) && vt.get(e);
            if (m && (u = m.events)) {
                for (t = (t || "").match(pt) || [""], c = t.length; c--;)
                    if (s = Dt.exec(t[c]) || [], p = g = s[1], h = (s[2] || "").split(".").sort(), p) {
                        for (f = Z.event.special[p] || {}, p = (r ? f.delegateType : f.bindType) || p, d = u[p] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = o = d.length; o--;) l = d[o], !i && g !== l.origType || n && n.guid !== l.guid || s && !s.test(l.namespace) || r && r !== l.selector && ("**" !== r || !l.selector) || (d.splice(o, 1), l.selector && d.delegateCount--, f.remove && f.remove.call(e, l));
        ...
        trigger: function(t, n, r, i) {
            ...
            if (a = s = r = r || J, 3 !== r.nodeType && 8 !== r.nodeType && !jt.test(p + Z.event.triggered) && (p.indexOf(".") >= 0 && (h = p.split("."), p = h.shift(), h.sort()), c = p.indexOf(":") < 0 && "on" + p, t = t[Z.expando] ? t : new Z.Event(p, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : Z.makeArray(n, [t]), f = Z.event.special[p] || {}, i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
                ...
                for (o = 0;
                    (a = d[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? u : f.bindType || p, l = (vt.get(a, "events") || {})[t.type] && vt.get(a, "handle"), l && l.apply(a, n), l = c && a[c], l && l.apply && Z.acceptData(a) && (t.result = l.apply(a, n), t.result === !1 && t.preventDefault());
                return t.type = p, i || t.isDefaultPrevented() || f._default && f._default.apply(d.pop(), n) !== !1 || !Z.acceptData(r) || c && Z.isFunction(r[p]) && !Z.isWindow(r) && (s = r[c], s && (r[c] = null), Z.event.triggered = p, r[p](), Z.event.triggered = void 0, s && (r[c] = s)), t.result
            }
        },
        dispatch: function(e) {
            e = Z.event.fix(e);
        ...
        fix: function(e) {
            ...
            var t, n, r, i = e.type,
                o = e,
                a = this.fixHooks[i];
            for (a || (this.fixHooks[i] = a = Nt.test(i) ? this.mouseHooks : St.test(i) ? this.keyHooks : {}), r = a.props ? this.props.concat(a.props) : this.props, e = new Z.Event(o), t = r.length; t--;) n = r[t], e[n] = o[n];
    ...
    Rt.optgroup = Rt.option, Rt.tbody = Rt.tfoot = Rt.colgroup = Rt.caption = Rt.thead, Rt.th = Rt.td, Z.extend({
        ...
        buildFragment: function(e, t, n, r) {
            for (var i, o, a, s, u, c, l = t.createDocumentFragment(), f = [], d = 0, p = e.length; p > d; d++)
                if (i = e[d], i || 0 === i)
                    if ("object" === Z.type(i)) Z.merge(f, i.nodeType ? [i] : i);
                    else if (Lt.test(i)) {
                for (o = o || l.appendChild(t.createElement("div")), a = (qt.exec(i) || ["", ""])[1].toLowerCase(), s = Rt[a] || Rt._default, o.innerHTML = s[1] + i.replace(At, "<$1></$2>") + s[2], c = s[0]; c--;) o = o.lastChild;
            ...
            for (l.textContent = "", d = 0; i = f[d++];)
                if ((!r || -1 === Z.inArray(i, r)) && (u = Z.contains(i.ownerDocument, i), o = v(l.appendChild(i), "script"), u && g(o), n))
                    for (c = 0; i = o[c++];) Pt.test(i.type || "") && n.push(i);
            return l
        },
        ...
        html: function(e) {
            return mt(this, function(e) {
                ...
                if ("string" == typeof e && !Ft.test(e) && !Rt[(qt.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = e.replace(At, "<$1></$2>");
                    try {
        ...
        domManip: function(e, t) {
            ...
            var n, r, i, o, a, s, u = 0,
                ...
                d = e[0],
                g = Z.isFunction(d);
            if (g || c > 1 && "string" == typeof d && !Q.checkClone && Ht.test(d)) return this.each(function(n) {
                var r = l.eq(n);
            ...
            if (c && (n = Z.buildFragment(e, this[0].ownerDocument, !1, this), r = n.firstChild, 1 === n.childNodes.length && (n = r), r)) {
                for (i = Z.map(v(n, "script"), p), o = i.length; c > u; u++) a = n, u !== f && (a = Z.clone(a, !0, !0), o && Z.merge(i, v(a, "script"))), t.call(this[u], a, u);
                if (o)
                    for (s = i[i.length - 1].ownerDocument, Z.map(i, h), u = 0; o > u; u++) a = i[u], Pt.test(a.type || "") && !vt.access(a, "globalEval") && Z.contains(s, a) && (a.src ? Z._evalUrl && Z._evalUrl(a.src) : Z.globalEval(a.textContent.replace(Ot, "")))
            }
            return this
        }
    }), Z.each({
    ...
    Z.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, a, s = Z.camelCase(t),
                    u = e.style;
                return t = Z.cssProps[s] || (Z.cssProps[s] = T(u, s)), a = Z.cssHooks[t] || Z.cssHooks[s], void 0 === n ? a && "get" in a && void 0 !== (i = a.get(e, !1, r)) ? i : u[t] : (o = typeof n, "string" === o && (i = Ut.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(Z.css(e, t)), o = "number"), null != n && n === n && ("number" !== o || Z.cssNumber[s] || (n += "px"), Q.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u[t] = n)), void 0)
            }
        },
        css: function(e, t, n, r) {
            var i, o, a, s = Z.camelCase(t);
            return t = Z.cssProps[s] || (Z.cssProps[s] = T(e.style, s)), a = Z.cssHooks[t] || Z.cssHooks[s], a && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = w(e, t, r)), "normal" === i && t in Gt && (i = Gt[t]), "" === n || n ? (o = parseFloat(i), n === !0 || Z.isNumeric(o) ? o || 0 : i) : i
        }
        ...
        }, Bt.test(e) || (Z.cssHooks[e + t].set = E)
    }), Z.fn.extend({
        css: function(e, t) {
    ...
    Z.extend({
        ...
        ajax: function(e, t) {
            ...
            if (h.promise(w).complete = g.add, w.success = w.done, w.error = w.fail, f.url = ((e || f.url || Cn) + "").replace(dn, "").replace(vn, Tn[1] + "//"), f.type = t.method || t.type || f.method || f.type, f.dataTypes = Z.trim(f.dataType || "*").toLowerCase().match(pt) || [""], null == f.crossDomain && (u = yn.exec(f.url.toLowerCase()), f.crossDomain = !(!u || u[1] === Tn[1] && u[2] === Tn[2] && (u[3] || ("http:" === u[1] ? "80" : "443")) === (Tn[3] || ("http:" === Tn[1] ? "80" : "443")))), f.data && f.processData && "string" != typeof f.data && (f.data = Z.param(f.data, f.traditional)), M(xn, f, t, w), 2 === x) return w;
            c = Z.event && f.global, c && 0 === Z.active++ && Z.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !mn.test(f.type), i = f.url, f.hasContent || (f.data && (i = f.url += (fn.test(i) ? "&" : "?") + f.data, delete f.data), f.cache === !1 && (f.url = pn.test(i) ? i.replace(pn, "$1_=" + ln++) : i + (fn.test(i) ? "&" : "?") + "_=" + ln++)), f.ifModified && (Z.lastModified[i] && w.setRequestHeader("If-Modified-Since", Z.lastModified[i]), Z.etag[i] && w.setRequestHeader("If-None-Match", Z.etag[i])), (f.data && f.hasContent && f.contentType !== !1 || t.contentType) && w.setRequestHeader("Content-Type", f.contentType), w.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + wn + "; q=0.01" : "") : f.accepts["*"]);
    ...
    Z.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !Z(this).is(":disabled") && jn.test(this.nodeName) && !Nn.test(e) && (this.checked || !Et.test(e))
            }).map(function(e, t) {
                var n = Z(this).val();
    ...
    }), Q.cors = !! Ln && "withCredentials" in Ln, Q.ajax = Ln = !! Ln, Z.ajaxTransport(function(e) {
        var t;
        return Q.cors || Ln && !e.crossDomain ? {
            send: function(n, r) {
                var i, o = e.xhr(),
                    a = ++Dn;
    ...
    Z.ajaxSetup({
        ...
        return s || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = Z.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Hn, "$1" + i) : t.jsonp !== !1 && (t.url += (fn.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
    ...
    return Z.noConflict = function(t) {
        return e.$ === Z && (e.$ = Rn), t && e.jQuery === Z && (e.jQuery = On), Z
...
queue = new createjs.LoadQueue, sceneName = "skyline";
var src = "scenes/" + sceneName,
    animationSrc = src + "/animation/inside.mp4",
    sceneryOutsideSrc = src + "/sceneries/outside.png",
    sceneryInsideSrc = src + "/sceneries/inside.svg",
    slothAnimationSrc = src + "/animation/sloth" + randomnumber + ".gif",
    underwaterAniSrc = src + "/animation/underwater_isolated.gif",
    audioSrc = src + "/audio/",
    successSrc = "scenes/success_screen/",
    successSentenceSrc = successSrc + "sentence" + randomsentence + ".svg",
    successSlothSrc = successSrc + "shine.gif";
$(window).resize(function() {
    ...
    function e(e) {
        ...
        var n = e.target ? e.target : e.srcElement,
            r = Math.floor(((screen.availWidth || 1024) - t.width) / 2),
            i = Math.floor(((screen.availHeight || 700) - t.height) / 2),
            o = window.open(n.href, "social", "width=" + t.width + ",height=" + t.height + ",left=" + r + ",top=" + i + ",location=0,menubar=0,toolbar=0,status=0,scrollbars=1,resizable=1");
        return o && (o.focus(), e.preventDefault && e.preventDefault(), e.returnValue = !1), !! o
    }
    for (var t = {
        link: "a.popup",
        width: 500,
        height: 500
    }, n = document.querySelectorAll(t.link), r = 0; r < n.length; r++) n[r].onclick = e
}), queue.on("progress", handleProgress, this), queue.on("complete", handleComplete, this), queue.on("fileload", handleFileLoad, this), Modernizr.touch ? $("#warning").css("width", "100vw").css("height", "100vh").css("opacity", "1") : preload();
